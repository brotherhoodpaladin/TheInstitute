...
; There are 31 types of components and matching scrap object in the game.
Group Components
...
;/
; Auto Recycling Function that takes component lists and checks for components (if any) from
